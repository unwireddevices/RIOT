...
/**
 * @defgroup    boards_unwd-range-l1-r2
 * @ingroup     boards
 * @brief       Board specific files for the Unwired Range L1 R160829 board.
 * @{
 *
 * @file
 * @brief       Board specific definitions for the Unwired Range L1 R160829 board.
 *
...
#define SX127X_DIO0 GPIO_PIN(PORT_A, 11)
#define SX127X_DIO1 GPIO_PIN(PORT_A, 10)
#define SX127X_DIO2 GPIO_PIN(PORT_A, 9)
#define SX127X_DIO3 GPIO_PIN(PORT_A, 8)
