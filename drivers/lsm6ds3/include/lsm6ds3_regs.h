 ...
 * @{
 * @file		lsm6ds3_regs.h
 * @brief       ST's LSM6DS3 6-axis motion sensor registers definitions
 * @author      EP <ep@unwds.com>
 */
#ifndef LSM6DS3_REGS_H_
#define LSM6DS3_REGS_H_

#define LSM6DS3_DEFAULT_ID 0x69
