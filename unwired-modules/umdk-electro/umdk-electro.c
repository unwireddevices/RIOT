...
#undef _UMDK_MID_
#define _UMDK_MID_ UNWDS_ELECTRO_MODULE_ID

/* define is autogenerated, do not change */
#undef _UMDK_NAME_
#define _UMDK_NAME_ "electro"
...
static void init_config(void) {
    ...
    if (!unwds_read_nvram_config(_UMDK_MID_, (uint8_t *) &umdk_electro_config, sizeof(umdk_electro_config)))
      return;
...
static inline void save_config(void) {
      umdk_electro_config.is_valid = 1;
      unwds_write_nvram_config(_UMDK_MID_, (uint8_t *) &umdk_electro_config, sizeof(umdk_electro_config));
}
...
#endif
>>>>>>> branch 'lora-star-simple' of git@unwds.com:riot
