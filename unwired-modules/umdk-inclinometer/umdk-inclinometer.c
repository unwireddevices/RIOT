...
static bool init_sensor(void) {
    ...
    lis2hh12_params.i2c = UMDK_INCLINOMETER_I2C;        /**< I2C device */
    ...
    dev_adxl345.i2c = I2C_DEV(UMDK_INCLINOMETER_I2C);
    dev_adxl345.addr = ADXL345_PARAM_ADDR;
    
    if (adxl345_init(&dev_adxl345, (adxl345_params_t*)adxl345_params) == ADXL345_OK) {
    ...
    lsm_params.i2c = UMDK_INCLINOMETER_I2C;
